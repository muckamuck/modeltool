...
from modeltool.stack_tool import StackTool
from modeltool.template_creator import TemplateCreator
from stackility import CloudStackUtility
from modeltool.pip_util import pipmain
...
LAMBDATOOL_DESCRIPTOR = '.modeltool'
    ...
    def deploy_lambda(self):
        ...
        try:
            if not self.read_descriptor():
                logging.error('problem reading ".modeltool" descriptor, exiting')
                return False
